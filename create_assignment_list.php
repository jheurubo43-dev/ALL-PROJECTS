...
if (mysqli_num_rows($verify) === 0) {
    die("Unauthorized: You don't own this subject.");
}
...
if (isset($_POST['submit_assignment'])) {
    ...
    if (empty($title) || empty($instructions) || empty($due_date)) {
        ...
        $query = "INSERT INTO assignments (title, instructions, subject_id, due_date, created_at) 
                  VALUES ('$title', '$instructions', $subject_id, '$due_date', NOW())";
    ...
    <div class="card form-card">
        <div class="header-gradient">
            ...
            <p class="mb-0 opacity-75">
                <i class="fas fa-book me-2"></i><?php echo htmlspecialchars($subject['name']); ?>
            </p>
        </div>
        ...
        <div class="card-body p-5">
            ...
            <form method="POST">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" name="submit_assignment" class="btn btn-primary btn-lg fw-bold">
                        <i class="fas fa-paper-plane me-2"></i> Publish Assignment
                    </button>
                    <a href="manage_subject.php?id=<?php echo $subject_id; ?>" class="btn btn-outline-secondary">
